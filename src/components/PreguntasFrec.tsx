...
const preguntas = [
  {pregunta: "¿QUE ES HUELLITAS PET SHOP?",respuesta:"Es el sitio web donde vas a poder encontrar todo lo que necesitás para tus mascotas.Registrándote en HUELLITAS PET SHOP vas a poder adquirir todos los productos que ofrecen las mejores veterinarias del país."},
  {pregunta: "¿QUE PRODUCTOS Y MARCAS VENDEN?",respuesta:"En HUELLITAS PET SHOP vas a encontrar todos los productos que ofrecen las veterinarias o petshops de renombre.Nuestro objetivo es que encuentres las mejores marcas en categorias principales como alimentos pero tambien accesorios para tu mascota."},
  ...
  return (
    <>
      ...
      <div className="preguntas-page">
        <h2 className="preguntas-titulo">PREGUNTAS FRECUENTES</h2>
